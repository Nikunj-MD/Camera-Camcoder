...
- (void)setStyle:(TVCalibratedSliderStyle)style {
    ...
    if(style == TavicsaStyle) {
        [self setMaximumTrackImage:@"progressbar_track.png" withCapInsets:UIEdgeInsetsMake(0, 16, 0, 16) forState:UIControlStateNormal];
        [self setMinimumTrackImage:@"progressbar_track.png" withCapInsets:UIEdgeInsetsMake(0, 16, 0, 16) forState:UIControlStateNormal];
        [self setThumbImage:@"slider_thumb_small" forState:UIControlStateNormal withOffsetRelativeToCenterOfTrack:CGPointMake(0, 0)];
        [self setThumbImage:@"slider_thumb_small" forState:UIControlStateHighlighted withOffsetRelativeToCenterOfTrack:CGPointMake(0, -15)];
    }
}
